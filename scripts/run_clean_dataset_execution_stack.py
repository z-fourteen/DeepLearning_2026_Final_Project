...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate clean_dataset GRU predictions with T+1 fill simulation and Barra-lite optimizer."
    )
...
def main() -> None:
    ...
    for run_name, predictions in RUNS.items():
        ...
        run_command(
            [
                sys.executable,
                "scripts/backtest_t1_fill_sim.py",
                "--predictions",
                str(predictions),
                "--execution-labels",
    ...
    manifest = {
        ...
        "method": "clean_dataset_strictmask_t1_fill_and_execution_label_optimizer",
    }
